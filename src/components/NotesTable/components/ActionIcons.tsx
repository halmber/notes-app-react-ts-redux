...
export const EditIcon: React.FC<IconsProps> = ({ handleClick }) => {
    return (
...
export const ArchiveIcon: React.FC<IconsProps> = ({ handleClick, className }) => {
    return (
        <svg onClick={handleClick} className={className} focusable="false" aria-hidden="true" viewBox="0 0 24 24">
...
export const DeleteIcon: React.FC<IconsProps> = ({ handleClick }) => {
    return (
        <svg onClick={handleClick} focusable="false" aria-hidden="true" viewBox="0 0 24 24">
